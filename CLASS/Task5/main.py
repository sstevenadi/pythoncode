...
if __name__ == "__main__":
    ...
    next1 = tk.Button(master=mainFrame, text="Next", command=lambda meja=lb_next1: next_antri(meja))
    next1.place(x=30, y=50)
    next2 = tk.Button(master=mainFrame, text="Next", command=lambda meja=lb_next2: next_antri(meja))
    next2.place(x=230, y=50)
    next3 = tk.Button(master=mainFrame, text="Next", command=lambda meja=lb_next3: next_antri(meja))
    next3.place(x=430, y=50)
    next4 = tk.Button(master=mainFrame, text="Next", command=lambda meja=lb_next4: next_antri(meja))
    ...
    antri = tk.Button(master=mainFrame, text="Queue", command=antrian)
